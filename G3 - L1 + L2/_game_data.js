...
const NAMES = [['Ken','肯恩'],['Alan','艾倫'],['Wendy','溫蒂'],['Mike','麥克'],['Emma','艾瑪']];
...
const G1 = [
 ...
 {q:'「我的名字是麥克。」', o:['My name is Mike.','I name is Mike.','My name Mike.','Your name is Mike.'], h:'My name is ＋ 名字。'},
...
const G2 = [].concat(
  ...
  [
   {txt:'___ am Ken.', zh:'我是肯恩。', a:'I', h:'am 前面用 I：I am。'},
   {txt:'___ am nine.', zh:'我九歲。', a:'I', h:'am 前面用 I：I am。'},
   {txt:'Hi! ___ name is Alan.', zh:'嗨！我的名字是艾倫。', a:'my', h:'name 前面用 My（我的）。'},
   {txt:'___’m twelve.', zh:'我十二歲。', a:'I', h:'I’m ＝ I am ＝ 我是。'},
   {txt:'Hello! ___ name is Wendy.', zh:'哈囉！我的名字是溫蒂。', a:'my', h:'name 前面用 My（我的）。'},
   {txt:'___ am seven years old.', zh:'我七歲。', a:'I', h:'am 前面用 I：I am。'},
   {txt:'___ name is Emma.', zh:'我的名字是艾瑪。', a:'my', h:'My name ＝ 我的名字。'}
  ]);
...
const G3 = [
 ...
 {s:['My','name','is','Ken','.'], zh:'我的名字是肯恩。', h:'My ➜ name ➜ is ➜ 名字。'},
 {s:['My','name','is','Wendy','.'], zh:'我的名字是溫蒂。', h:'跟中文一樣：我的 名字 是 溫蒂。'},
 {s:['My','name','is','Mike','.'], zh:'我的名字是麥克。', h:'My name is ＋ 名字。'},
 {s:['I’m','Alan','.'], zh:'我是艾倫。', h:'I’m ＋ 名字。'},
 {s:['I','am','Emma','.'], zh:'我是艾瑪。', h:'I ➜ am ➜ 名字。'},
 ...
 {s:['My','name','is','Emma','.'], zh:'我的名字是艾瑪。', h:'My name is ＋ 名字。'},
 {s:['I’m','Wendy','.'], zh:'我是溫蒂。', h:'I’m ＋ 名字。'},
 {s:['I','am','Ken','.'], zh:'我是肯恩。', h:'I ➜ am ➜ 名字。'},
...
const G6 = [
 ...
 ['My name is Ken.','我的名字是肯恩。'], ["I'm Mike.",'我是麥克。'],
...
const G7 = [
 ...
 {w:['My','name','is','Ken','.'], b:-1, zh:'我的名字是肯恩。', h:'這一句完全正確。'},
 {w:['I','name','is','Ken','.'], b:0, fix:'My', zh:'我的名字是肯恩。', h:'「我的」名字要用 My。'},
 {w:['Your','name','is','Wendy','.'], b:0, fix:'My', zh:'我的名字是溫蒂。', h:'說自己的名字用 My。'},
 {w:['My','name','Emma','.'], b:2, fix:'is Emma', zh:'我的名字是艾瑪。', h:'My name 後面要有 is。'},
 {w:['I’m','Mike','.'], b:-1, zh:'我是麥克。', h:'這一句完全正確。'},
 {w:['My','Mike','.'], b:0, fix:'I’m', zh:'我是麥克。', h:'「我是」要用 I’m。'},
...
const G8 = [
 ...
 {b:'___', a:'name is Ken.', zh:'我的名字是肯恩。', o:['My','I','Your','Me'], h:'我的 ＝ My。'},
 {b:'My name', a:'Alan.', zh:'我的名字是艾倫。', o:['is','am','are','’m'], h:'name 配 is。'},
 {b:'My', a:'is Wendy.', zh:'我的名字是溫蒂。', o:['name','old','years','you'], h:'名字 ＝ name。'},
 {b:'___', a:"'m Mike.", zh:'我是麥克。', o:['I','My','You','Me'], h:'I’m ＝ I am ＝ 我是。'},
 {b:'I', a:'Emma.', zh:'我是艾瑪。', o:['am','is','are','my'], h:'I 配 am。'},
...
/* ── 🎁 正向驚喜卡：十個遊戲各 30 張，300 張名字全部不重複（使用者 2026-09-24 指定）──
 * 每一場重新洗牌、抽過不再抽；翻開那一刻卡片上的圖示炸滿整個畫面（四種炸法隨機）。
 * 每一個遊戲的 30 張，效果（種類＋數值）也都不一樣：
 *   pts 加分 ｜ lucky 神秘紅包（翻開才知道幾分）｜ x2／x3 接下來 v 題分數加倍 ｜ time 下一題多 v 秒
 *   fast 下一題 5 秒內答對再加分 ｜ streak 連對直接加 ｜ shield 護盾（答錯連對不歸零） */
const FX = [
 ['pts',150],['pts',250],['pts',300],['pts',350],['pts',500],['pts',600],['pts',700],['pts',800],['pts',900],['pts',1000],
 ['lucky',[100,1000]],['lucky',[200,800]],['lucky',[300,1200]],['lucky',[50,1500]],
 ['x2',2],['x2',3],['x2',4],['x3',1],['x3',2],
 ['time',6],['time',8],['time',10],['time',12],
 ['fast',300],['fast',400],['fast',500],
 ['streak',2],['streak',3],['streak',4],
 ['shield',1]
];
...
const SURP = {};
Object.keys(THEME).forEach(function (g, gi) {
  const names = THEME[g].split(' ').map(s => s.replace(/^(\S+?)([一-鿿])/, '$1 $2'));
  if (names.length !== 30) throw new Error(g + ' 驚喜卡不是 30 張：' + names.length);
  /* 每個遊戲把效果錯開一點，同一個名字位置不會都拿到一樣的效果 */
  SURP[g] = names.map((t, n) => { const f = FX[(n + gi * 7) % FX.length]; return {t: t, k: f[0], v: f[1]}; });
});
...
/* 引擎設定：翻開驚喜卡炸滿畫面、神秘紅包、每個遊戲至少 30 張（量測會檢查） */
const CFG = { burst: true, lucky: true, minSurp: 30 };
